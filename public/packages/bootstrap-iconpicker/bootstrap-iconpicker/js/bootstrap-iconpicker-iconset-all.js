        ...
        allVersions: [
            ...
            },
            {
                ...
                icons: [
                    ...
                    'fas fa-hand-pointerSlice',
                    'far fa-hand-pointerSlice',
                    'fas fa-hand-rock',
                    'far fa-hand-rock',
        ...
        allVersions: [
            ...
            },
            {
                ...
                icons: [
                    ...
                    'fas fa-bullseye-pointerSlice',
                    'far fa-bullseye-pointerSlice',
                    'fal fa-bullseye-pointerSlice',
                    'far fa-burn',
                    'fal fa-burn',
                    'far fa-bus',
                    'fal fa-bus',
                    ...
                    'far fa-motorcycle',
                    'fal fa-motorcycle',
                    'far fa-mouse-pointerSlice',
                    'fal fa-mouse-pointerSlice',
                    'far fa-music',
                    'fal fa-music',
                    'far fa-neuter',
                    'fal fa-neuter',
